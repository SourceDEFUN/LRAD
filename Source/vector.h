...
// Secton: Get out of here Weiver, tell them i failed...
#ifndef unix
FORCEINLINE float FASTCALL _VectorNormalize (Vector& vec)
{
...
// Secton: there was used to be a FORCEINLINE but it just does not work. Damn it!
